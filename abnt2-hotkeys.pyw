...
def backslash2():
    # devido a esse bug ou 'feature' do pynput, ao teclar alt_gr+n, como ainda não soltei o alt_gr, ele tecla o alt_gr+\\, que não acontece nada. aí, tenho que fazer o mapeamento de alt_gr+\\ tbm, para, aí sim, pressionar apenas o \\
    Global.controller.type("\\")
